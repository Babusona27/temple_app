...
Route::group(['middleware' => ['installer']], function () {
    ...
    ////////////////////////////////////////////////////////////////////////////////////
        ...
        // Route::get('/webpages', 'PagesController@webpages');
        // Route::get('/addwebpage', 'PagesController@addwebpage');
        // Route::post('/addnewwebpage', 'PagesController@addnewwebpage');
        // Route::get('/editwebpage/{id}', 'PagesController@editwebpage');
        // Route::post('/updatewebpage', 'PagesController@updatewebpage');
        // Route::get('/pageWebStatus', 'PagesController@pageWebStatus');
