...
class Customers extends Model
{
    ...
    public function edit($id){
      ...
      $customers = DB::table('users')
        ->LeftJoin('address_book','address_book.user_id','=', 'users.id')
        ->select('users.*', 'address_book.entry_street_address as entry_street_address',
          'address_book.entry_postcode as entry_postcode', 'address_book.entry_city as entry_city')
        ->where('id','=', $id)
        ->first();
      return $customers;
    ...
    $parameter = $request->parameter;
        switch ( $filter )
        {
            case 'Name':
                $user = DB::table('users')
                    ->LeftJoin('address_book','address_book.user_id','=', 'users.id')
                    ->select('users.*', 'address_book.entry_street_address as entry_street_address','address_book.entry_postcode as entry_postcode', 'address_book.entry_city as entry_city')
