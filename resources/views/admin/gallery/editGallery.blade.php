...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> Edit Gallery <small>Edit Gallery...</small> </h1>
        <ol class="breadcrumb">
            <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
            <li><a href="{{ URL::to('admin/customers/display')}}"><i class="fa fa-users"></i>  Listing All Gallerys</a></li>
                      ...
                      <div class="row">
                        <div class="col-xs-12">
                          <div class="box box-info">
                            ...
                            <div class="box-body">
                              {!! Form::open(array('url' =>'admin/gallery/updateGallery', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                              {!! Form::hidden('gallery_id', $result['gallery_details']->gallery_id, array('class'=>'form-control')) !!}
                              <hr>
                              <div class="form-group">
                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Title') }} </label>
                                <div class="col-sm-10 col-md-4">
                                  {!! Form::text('gallery_name',  $result['gallery_details']->gallery_name, array('class'=>'form-control field-validate', 'id'=>'gallery_name')) !!}
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                  {!! Form::textarea('gallery_dec', $result['gallery_details']->gallery_dec, array('class'=>'form-control field-validate', 'id'=>'gallery_dec', 'rows' => 2, 'cols' => 40)) !!}
