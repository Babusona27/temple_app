...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> CMS Pages <small>Add CMS Page...</small> </h1>
            <ol class="breadcrumb">
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/cmspages/insert', 'method'=>'post', 'class' => 'form-horizontal form-validate' )) !!}

                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Title</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="cms_page_title" class="form-control field-validate" value="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <textarea id="editor1" name="cms_page_Content" class="form-control"  rows="10" cols="80"></textarea>
