...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> Add User <small>Add User...</small> </h1>
        <ol class="breadcrumb">
                          ...
                          <div class="box box-info">
                            ...
                            <div class="box-body">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                  {!! Form::text('customers_telephone',  '', array('class'=>'form-control field-validate phone-validate', 'id'=>'customers_telephone')) !!}
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                  <textarea id="entry_street_address" name="entry_street_address" rows="4" cols="50" class="form-control field-validate"></textarea>
